...
export default function ExampleTreeView() {
  ...
  return (
    <div className="flex flex-col gap-1">
      <h3 className="text-sm font-medium text-gray-900 mb-2">Project Files (Single Selection)</h3>
      <TreeView.Root
      ...
      >
        <TreeView.Item value="src">
          <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
            ...
            <TreeView.ItemLabel className="font-medium text-gray-900">src</TreeView.ItemLabel>
          ...
          <TreeView.ItemGroup className="pl-5 data-[ending-style]:hidden">
              ...
              <TreeView.ItemGroup className="pl-5 data-[ending-style]:hidden">
                <TreeView.Item value="header">
                  <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
                    ...
                    <TreeView.ItemLabel className="text-gray-900">Header.tsx</TreeView.ItemLabel>
                  </TreeView.ItemContent>
                </TreeView.Item>
                <TreeView.Item value="footer">
                  <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
                    <span className="w-4" />
                    <FileIcon className="w-4 h-4 text-gray-500" />
                    <TreeView.ItemLabel className="text-gray-900">Footer.tsx</TreeView.ItemLabel>
                  </TreeView.ItemContent>
                </TreeView.Item>
              </TreeView.ItemGroup>
            </TreeView.Item>
            <TreeView.Item value="utils">
              <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
                ...
                <FolderIcon className="w-4 h-4 text-blue-500" />
                <TreeView.ItemLabel className="font-medium text-gray-900">utils</TreeView.ItemLabel>
              </TreeView.ItemContent>
              <TreeView.ItemGroup className="pl-5 data-[ending-style]:hidden">
                <TreeView.Item value="format">
                  <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
                    <span className="w-4" />
                    <FileIcon className="w-4 h-4 text-gray-500" />
                    <TreeView.ItemLabel className="text-gray-900">format.ts</TreeView.ItemLabel>
                  </TreeView.ItemContent>
                </TreeView.Item>
              </TreeView.ItemGroup>
            </TreeView.Item>
            <TreeView.Item value="app">
              <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
                <span className="w-4" />
                <FileIcon className="w-4 h-4 text-gray-500" />
                <TreeView.ItemLabel className="text-gray-900">App.tsx</TreeView.ItemLabel>
              </TreeView.ItemContent>
            </TreeView.Item>
          </TreeView.ItemGroup>
        </TreeView.Item>
        ...
        <TreeView.Item value="public">
          <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
            ...
            <FolderIcon className="w-4 h-4 text-blue-500" />
            <TreeView.ItemLabel className="font-medium text-gray-900">public</TreeView.ItemLabel>
          </TreeView.ItemContent>
          <TreeView.ItemGroup className="pl-5 data-[ending-style]:hidden">
            <TreeView.Item value="logo">
              <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
                <span className="w-4" />
                <FileIcon className="w-4 h-4 text-gray-500" />
                <TreeView.ItemLabel className="text-gray-900">logo.svg</TreeView.ItemLabel>
              </TreeView.ItemContent>
            </TreeView.Item>
          </TreeView.ItemGroup>
        </TreeView.Item>
        ...
        <TreeView.Item value="work">
          <TreeView.ItemContent className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600 data-[selected]:bg-blue-100 data-[selected]:hover:bg-blue-200">
            <span className="w-4" />
            <FileIcon className="w-4 h-4 text-gray-500" />
            <TreeView.ItemLabel className="text-gray-900">package.json</TreeView.ItemLabel>
          </TreeView.ItemContent>
        </TreeView.Item>
      </TreeView.Root>
    </div>

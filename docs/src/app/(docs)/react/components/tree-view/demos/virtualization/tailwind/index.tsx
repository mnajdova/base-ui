...
export default function ExampleTreeView() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <h3 className="text-sm font-medium text-gray-900">Large Tree (Virtualized)</h3>
      <div
        className="w-80 h-80 overflow-auto rounded-lg border border-gray-200 bg-white relative"
        ref={scrollRef}
      ...
      >
        <TreeView.Root
          ...
          className="w-full relative text-sm p-3"
            ...
            return (
              ...
              >
                <TreeView.ItemContent
                  className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-100 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-blue-600"
                ...
                >
                  ...
                  <TreeView.ItemLabel className="text-gray-900">{node.label}</TreeView.ItemLabel>
                </TreeView.ItemContent>
              </TreeView.Item>
            );
          })}
